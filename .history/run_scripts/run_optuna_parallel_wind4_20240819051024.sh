...
CUDA_VISIBLE_DEVICES=0 python /data/Pein/Pytorch/Wind-Power-Prediction/run_scripts/run_optuna.py >/data/Pein/Pytorch/Wind-Power-Prediction/tmux_console_6.log 2>&1 &

# Sleep for seconds to allow the first instance to start
sleep 3

# Run the second instance with GPU 1 in the background
CUDA_VISIBLE_DEVICES=1 python /data/Pein/Pytorch/Wind-Power-Prediction/run_scripts/run_optuna.py >/data/Pein/Pytorch/Wind-Power-Prediction/tmux_console_7.log 2>&1 &
